...
async function generateEnvExample({
  ...
  header = `#  Generated by genv-ex on: ${new Date().toISOString()} (UTC)
#
#  Purpose: This \`.env.example\` file is intended to be
#  committed to version control to help developers and
#  collaborators understand which environment variables
#  are needed — **without exposing sensitive values.**\n\n`,
  force = true,
  silent = false,
  dryRun = false,
